...
// const saltRounds= 10;
const session= require("express-session");   //-->for sessions and cookies
...
passport.use(new GoogleStrategy({
    ...
    userProfileUrl: "http://www.googleapis.com/oautho2/v3/useinfo"
  },
...
app.post("/submit", function(req,res){
    ...
    User.findById(req.user._id, function(err, foundItem){
        if(!err){
            if(foundItem){
                foundItem.secret= newSecret;
                foundItem.save();
                res.redirect("/secrets");
            }
        }
